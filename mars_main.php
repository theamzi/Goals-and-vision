<?php
require('header.php');
/* This script will remove the chosen category from the db */            
...
$sqli="DELETE FROM mars WHERE mars_id='$tar_id'";
...
/* This site will display the categories and definitions the users has entered */ 
            
echo "<div class='awesometext' id='nextplanet'> <p> Mars </p> </div>";
        ...
        while ($row=$result->fetch_assoc()){
            ...
            . "<form method='get' action='mars_update.php'>
            <input type='hidden' name='cat' value='".$row['category']."'/>
            <input type='hidden' name='def' value='".$row['definition']."'/>
            <input type='hidden' name='tar_id' value='".$row['mars_id']."'/>
             <input type='image' name='update_tar' src='img/function_navigation/pen1.png' alt='Submit'/>
            </form>"
                
            . "<form method='post' action='mars_main.php'>
            <input type='hidden' name='tarid' value='".$row['mars_id']."'/>
            <input type='image' value='delete' name='remove' onClick=\"return confirm('Are you sure?')\" src='img/function_navigation/delete.png' alt='Submit'/></form></td>";
...
window.onload = function(){
        ...
        <!-- Add a category to Mars -->
        <div id="nextedit">
       <a href="mars_admin.php"><img src="img/function_navigation/add.png"></a> 
    
   </div>
  
<div id="moonfooter">
  
    <img src="img/Planets_backgrounds/mars2.png">
