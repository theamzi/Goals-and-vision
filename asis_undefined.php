...
/* If the user has not defined their as_is they will be sent here. They will be asked to fill in the current state, to be able to start the journey */ 
...
<a href="asis_admin.php">
    <h2>Hello and welcome to asis planet...</h2>
 <img src="img/Planets_backgrounds/earth.png" alt="No rocket"></a>


<p>To define your asis planet,</p>
      <p>press the planet</p>
