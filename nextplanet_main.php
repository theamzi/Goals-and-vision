...
$sqli="DELETE FROM targets WHERE target_id='$tar_id'";
...
echo "<div class='awesometext' id='nextplanet'> <p> Next planet </p> </div>";
        ...
        while ($row=$result->fetch_assoc()){
            ...
            . "<form method='get' action='nextplanet_update.php'>
            <input type='hidden' name='cat' value='".$row['category']."'/>
            <input type='hidden' name='def' value='".$row['definition']."'/>
            <input type='hidden' name='tar_id' value='".$row['target_id']."'/>
             <input type='image' name='update_tar' src='img/function_navigation/pen1.png' alt='Submit'/>
            </form>"
                
            . "<form method='post' action='nextplanet_main.php'>
            <input type='hidden' name='tarid' value='".$row['target_id']."'/>
            <input type='image' value='delete' name='remove' onClick=\"return confirm('Are you sure?')\" src='img/function_navigation/delete.png' id='remove' alt='Submit'/></form></td>";
...
window.onload = function(){
        ...
        <div id="nextedit">
       <a href="nextplanet_admin.php"><img src="img/function_navigation/add.png"></a> 
    
   </div>
  
<div id="moonfooter">
  
    <img src="img/Planets_backgrounds/moon2.png">
