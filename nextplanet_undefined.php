...
<div class="space"></div>
     ...
     <div class="nextplanet_admin">
         <h2>Hello and welcome to the Moon</h2>
<a href="nextplanet_admin.php">
 <img src="img/Planets_backgrounds/moon.png" alt="No rocket"></a>

  
         <p>To start defining your target, </p>
