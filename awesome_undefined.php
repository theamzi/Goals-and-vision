...
/* A site that will tell the user to fill in the awesome planet */
...
<div class="space"></div>
  ...
  <div class="nextplanet_admin">
      <h2>Hello and welcome to Planet Awesome...</h2>
<a href="awesome_admin.php">
 <img src="img/Planets_backgrounds/uranus.png" alt="No rocket"></a>

  
<h4> To define your Planet Awesome,</h4>
  <h4>  press the planet</h4>
</div> 
